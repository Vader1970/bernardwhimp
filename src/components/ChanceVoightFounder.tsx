...
import { ChanceVoightFounderProps, ChanceVoightFounderDefaults } from "../constants/types/chanceVoightFounder";

export const ChanceVoightFounder = (props: Partial<ChanceVoightFounderProps>) => {
